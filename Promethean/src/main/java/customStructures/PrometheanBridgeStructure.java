...
public class PrometheanBridgeStructure extends Structure<NoFeatureConfig>{
	public PrometheanBridgeStructure(Codec<NoFeatureConfig> codec) {
		super(codec);
    ...
    public  IStartFactory<NoFeatureConfig> getStartFactory() {
        return PrometheanBridgeStructure.Start::new;
    }
    	...
    	public void func_230364_a_(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn, NoFeatureConfig config) {
            ...
            JigsawManager.func_242837_a(
                    ...
                    new VillageConfig(() -> dynamicRegistryManager.getRegistry(Registry.JIGSAW_POOL_KEY)
                            .getOrDefault(new ResourceLocation(Promethean.MODID, "promethean_bridge/start_pool")),
                            20),
            ...
            Promethean.LOGGER.debug("Bridge at " +
